...
namespace IIS.KursovayaRabotaIspravleno
{
    ...
    public class Заказ : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.KursovayaRabotaIspravleno.ВидНосителя fНоситель;
        
        private IIS.KursovayaRabotaIspravleno.Фотокиоск fФотокиоск;
        
        private IIS.KursovayaRabotaIspravleno.Клиент fКлиент;
        
        private IIS.KursovayaRabotaIspravleno.DetailArrayOfФото fФото;
        ...
        public virtual IIS.KursovayaRabotaIspravleno.ВидНосителя Носитель
        {
            get
            {
                ...
                IIS.KursovayaRabotaIspravleno.ВидНосителя result = this.fНоситель;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.KursovayaRabotaIspravleno.Клиент Клиент
        {
            get
            {
                ...
                IIS.KursovayaRabotaIspravleno.Клиент result = this.fКлиент;
        ...
        [PropertyStorage(new string[] {
                "Фотокиоск"})]
        [NotNull()]
        public virtual IIS.KursovayaRabotaIspravleno.Фотокиоск Фотокиоск
        {
            get
            {
                ...
                IIS.KursovayaRabotaIspravleno.Фотокиоск result = this.fФотокиоск;
        ...
        public virtual IIS.KursovayaRabotaIspravleno.DetailArrayOfФото Фото
        {
            get
            {
                ...
                if ((this.fФото == null))
                {
                    this.fФото = new IIS.KursovayaRabotaIspravleno.DetailArrayOfФото(this);
                }
                IIS.KursovayaRabotaIspravleno.DetailArrayOfФото result = this.fФото;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказE", typeof(IIS.KursovayaRabotaIspravleno.Заказ));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаказL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказL", typeof(IIS.KursovayaRabotaIspravleno.Заказ));
                }
            }
        }
    }
