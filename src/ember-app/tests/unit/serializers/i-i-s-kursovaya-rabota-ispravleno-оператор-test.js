...
moduleForModel('i-i-s-kursovaya-rabota-ispravleno-оператор', 'Unit | Serializer | i-i-s-kursovaya-rabota-ispravleno-оператор', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kursovaya-rabota-ispravleno-оператор',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
