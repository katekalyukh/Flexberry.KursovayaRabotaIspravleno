...
moduleForModel('i-i-s-kursovaya-rabota-ispravleno-заказ', 'Unit | Serializer | i-i-s-kursovaya-rabota-ispravleno-заказ', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kursovaya-rabota-ispravleno-заказ',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
