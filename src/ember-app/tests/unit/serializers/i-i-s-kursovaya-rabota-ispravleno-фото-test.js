...
moduleForModel('i-i-s-kursovaya-rabota-ispravleno-фото', 'Unit | Serializer | i-i-s-kursovaya-rabota-ispravleno-фото', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kursovaya-rabota-ispravleno-фото',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
