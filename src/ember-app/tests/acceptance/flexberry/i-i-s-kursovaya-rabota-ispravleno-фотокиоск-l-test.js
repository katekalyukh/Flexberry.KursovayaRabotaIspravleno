...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya rabota ispravleno фотокиоск l');

test('testing i-i-s-kursovaya-rabota-ispravleno-фотокиоск-l', function(assert) {
