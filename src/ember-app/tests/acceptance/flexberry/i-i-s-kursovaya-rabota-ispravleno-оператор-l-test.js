...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya rabota ispravleno оператор l');

test('testing i-i-s-kursovaya-rabota-ispravleno-оператор-l', function(assert) {
